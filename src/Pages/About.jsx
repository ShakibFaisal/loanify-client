...
const AboutUs = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="text-base-content/70 mb-4 leading-relaxed">
            <span className="font-semibold text-primary">Loanify</span> is a digital loan
        ...
        {/* Right Box */}
        <div className="bg-base-200 shadow-lg rounded-xl p-6 transition-colors duration-300">
      ...
      {/* Mission Section */}
      <div className="mt-14 bg-base-200/50 rounded-xl p-8 text-center transition-colors duration-300">
